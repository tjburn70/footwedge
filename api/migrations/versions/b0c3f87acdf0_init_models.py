...
Revision ID: b0c3f87acdf0
Revises: 
Create Date: 2020-04-27 17:14:00.624313
...
def upgrade():
    op.create_table(
        ...
        sa.Column('role', sa.String(), nullable=False, default='standard_user'),
        sa.Column('created_ts', sa.DateTime(), nullable=False, default=datetime.utcnow()),
    ...
    op.create_table(
        ...
        sa.Column('record_start_date', sa.DateTime, nullable=False, default=datetime.utcnow()),
    ...
    op.create_table(
        ...
        sa.Column('towards_handicap', sa.Boolean(), nullable=False, default=True),
    ...
    op.create_table(
        ...
        sa.Column('putts', sa.Integer(), nullable=False, default=0),
        sa.Column('chips', sa.Integer(), nullable=False, default=0),
        sa.Column('greenside_sand_shots', sa.Integer(), nullable=False, default=0),
...
def downgrade():
    op.drop_table('golf_round_stats')
    op.drop_table('golf_round')
    op.drop_table('hole')
    op.drop_table('tee_box')
    op.drop_table('golf_course')
    op.drop_table('golf_club')
